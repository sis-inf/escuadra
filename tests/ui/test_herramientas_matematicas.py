...
from escuadra.modulos.matematicas.herramienta_conversion_unidades import (
    HerramientaConversionUnidades,
)
from escuadra.modulos.matematicas.herramienta_calculadora_cientifica import (
    HerramientaCalculadoraCientifica,
)
from escuadra.modulos.matematicas.herramienta_sistemas_lineales import (
    HerramientaSistemasLineales,
)
...
class TestHerramientaConversionUnidades:
    ...
    @pytest.mark.xfail(
        reason="La conversión de temperatura no se actualiza correctamente en el entorno de prueba de Qt"
    )
...
class TestHerramientaSistemasLineales:
    ...
    @pytest.mark.xfail(
        reason="El sistema 2x2 no se resuelve correctamente en el entorno de prueba de Qt"
    )
