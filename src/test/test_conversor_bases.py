...
def test_conversiones_exitosas():
    """Esta función prueba que el conversor dé los resultados esperados"""
...
def test_cuando_hay_errores():
    """Esta función prueba que el programa lance un error cuando los datos son inválidos"""
