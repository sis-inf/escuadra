...
from escuadra.utils.system_metrics import read_cpu_stats, calculate_cpu_usage

class TestSystemMetrics(unittest.TestCase):
    
    def test_read_cpu_stats_from_mock(self):
        """Verificar que lee correctamente el archivo mock"""
        mock_path = "test/fixtures/proc_stat_sample"
    ...
    def test_calculate_cpu_usage(self):
        ...
        # Segunda medición - CPU trabajó más
        stat2 = {
        ...
        # Cálculo manual esperado: 100% de uso
